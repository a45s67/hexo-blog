...
```
# redpill
題目給了一個沒任何說明的檔案 {% asset_link redpill %}
...
{% asset_img redpill-2.png 550 終於成功載入 %}
...
{% asset_img redpill-6.png 550 %}

最後追到使用 `ACCESS DENY` 的 0x307，前面的 asm 則是使用 `0x6585`、`0x65af` 做了某種處理及比對。
{% asset_img redpill-7.png 550 %}

先檢查一下這兩個 buf 執行前的內容
{% asset_img redpill-9.png 550 %}
{% asset_img redpill-8.png 550 %}
